...
def clean_and_predict(file_path, output_file_path):
    # Load the data
...
output_file_path = 'C:/Users/Nandini/Desktop/TRY1/TRY1/output.xlsx'
clean_and_predict(file_path, output_file_path)
